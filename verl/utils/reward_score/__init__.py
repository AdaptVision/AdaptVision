...
def _default_compute_score(data_source, solution_str, ground_truth, extra_info=None, **kwargs):
    ...
    if data_source in [
        ...
        elif extra_info[reward_fn_key] == 'general_qa_bbox':
            from verl.utils.reward_score import general_qa_bbox
            res = general_qa_bbox.compute_score(kwargs['prompt'], solution_str, ground_truth, extra_info)
    else:
